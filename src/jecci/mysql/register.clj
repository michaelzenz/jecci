...
(defrecord my-AtomicClient [dbclient]
  client/Client
  (open! [this test node]
    (my-AtomicClient. (client/open! dbclient test node)))
  (setup! [this test]
...
(defn gen-AtomicClient [conn]
  (my-AtomicClient. (r/gen-AtomicClient conn AtomicClientTranslation)))
