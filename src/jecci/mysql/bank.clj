...
(defrecord my-BankClient [dbclient]
  client/Client
  (open! [this test node]
    (my-BankClient. (client/open! dbclient test node)))
  (setup! [this test]
...
(defn gen-BankClient [conn]
  (my-BankClient. (b/gen-BankClient conn BankClientTranslation)))
...
(defrecord my-MultiBankClient [multibankclient]
  client/Client
  (open! [this test node]
    (my-MultiBankClient. (client/open! multibankclient test node)))
  (setup! [this test]
...
(defn gen-MultiBankClient [conn tbl-created?]
  (my-MultiBankClient. (b/gen-MultiBankClient conn tbl-created? MultiBankClientTranslation)))
