...
(defrecord my-IncrementClient [dbclient]
  client/Client
  (open! [this test node]
    (my-IncrementClient. (client/open! dbclient test node)))
  (setup! [this test]
...
(defn gen-IncrementClient [conn]
  (my-IncrementClient. (m/gen-IncrementClient conn IncrementClientTranslation)))
